  ...
  async copy(userId: string, id: string, name?: string) {
    ...
    return this.prisma.resumeVersion.create({
      data: {
        ...
        contentWorkExperiences: original.contentWorkExperiences as any[],
        contentProjectExperiences: original.contentProjectExperiences as any[],
    ...
    try {
      ...
      const updated = await this.prisma.resumeVersion.update({
        ...
        data: {
          ...
          contentSkills: generatedContent.skills,
          contentWorkExperiences: generatedContent.workExperiences,
          contentProjectExperiences: generatedContent.projectExperiences,
          contentCertificates: generatedContent.certificates,
          contentSelfEvaluation: generatedContent.selfEvaluation,
          aiOptimizationNotes: generatedContent.optimizationNotes,
          aiGapAnalysis: generatedContent.gapAnalysis,
        },
        include: {
          jobTarget: true,
          profile: true,
  ...
  async updateContent(userId: string, id: string, content: {
    ...
    return this.prisma.resumeVersion.update({
      ...
      data: {
        ...
        contentWorkExperiences: content.workExperiences,
        contentProjectExperiences: content.projectExperiences,
        contentCertificates: content.certificates,
